...
class Factura {
    ...
    verProdadd() {
        this.prodadds.forEach((prodadd) => {
            var _a;
            console.log("Nombre:", prodadd.nombre, "|cantidad: " + prodadd.cantidad, "|costo: " + prodadd.precio.toFixed(2), "|Propina: " + ((_a = prodadd.Propina) === null || _a === void 0 ? void 0 : _a.toFixed(2)));
        });
    }
    FacturaIva() {
